...
public class HamcrestMatchersIntro {
    ...
    public void simpleTest1() {
        ...
        // number comparison
        // greaterThan()
        assertThat(1 - 5, greaterThan(-10));
        // greaterThanOrEqualTo()
        // lessThan()
        assertThat(1 - 5, lessThan(10));
        // lessThanOrEqualTo()
    ...
    public void stringHamcrest() {
        String text = "EU8 is learning HC";

        // checking for equality is same as numbers
        assertThat(text, is("EU8 is learning HC"));
        assertThat(text, equalTo("EU8 is learning HC"));
        assertThat(text, is(equalTo("EU8 is learning HC")));
        ...
        // endsWith
        assertThat(text, endsWith("HC"));

        // check if text contains String learning
        assertThat(text, containsString("learning"));

        // with ignoring case
        assertThat(text, containsStringIgnoringCase("lear"));
